...
Parsec is a cryptocurrency, running off P2P Parsec Node connections. Parsec is secure, private and connected. Parsec has an adaptive block size limit and adaptive difficulty, with a stable emission rate.

## Building a Parsec Node
...
git clone https://github.com/parsecnode/parsec.git
cd parsec
mkdir build
cd build
cmake ..
...
Build a Parsec Node for 32 bit Android
```
